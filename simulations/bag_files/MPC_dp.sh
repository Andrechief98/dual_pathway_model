...
do
    ...
    # 2. Simulation + amygdala
    open_ros_window "SIM_RUN_$i" "roslaunch mpc_planner test_architecture.launch use_warm_start:=true high_road_influence:=0.5 test:='dp'"
    sleep 15
    ...
    # 6.  Starting experiment (publishing robot's goal)
