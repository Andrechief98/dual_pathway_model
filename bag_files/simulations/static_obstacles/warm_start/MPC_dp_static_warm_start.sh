...
BAG_NAME="MPC_dp_static_warm_start"  
...
DEST_FOLDER="/home/ros_ws/src/dual_pathway_model/bag_files/simulations/static_obstacles/warm_start"
...
open_ros_window "SIMULATION" "roslaunch mpc_planner test_architecture_static.launch use_warm_start:=true high_road_influence:=0.5"
sleep 10
