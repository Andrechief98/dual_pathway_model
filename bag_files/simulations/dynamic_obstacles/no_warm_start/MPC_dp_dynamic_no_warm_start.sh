...
BAG_NAME="MPC_dp_dynamic_no_warm_start"  
...
open_ros_window "SIMULATION" "roslaunch mpc_planner test_architecture_dynamic.launch use_warm_start:=false high_road_influence:=0.5"
sleep 10
