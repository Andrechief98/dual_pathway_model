...
# open_ros_window "SIMULATION" "roslaunch mpc_planner test_architecture_dynamic.launch use_warm_start:=true test:=''"
# sleep 10
...
do
  ...
  # 1. Simulation
  open_ros_window "SIM_RUN_$i" "roslaunch mpc_planner test_architecture_dynamic.launch use_warm_start:=true test:=''"
  sleep 10
