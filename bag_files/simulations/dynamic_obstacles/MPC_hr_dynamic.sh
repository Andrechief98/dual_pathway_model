...
do
  ...
  # 1. Simulation - amygdala
  open_ros_window "SIM_RUN_$i" "roslaunch mpc_planner test_architecture_dynamic.launch use_warm_start:=true high_road_influence:=1.0 test:='hr'"
  sleep 10
