...
# open_ros_window "SIMULATION" "roslaunch mpc_planner test_architecture_dynamic.launch use_warm_start:=true test:='lr'"
# sleep 5
...
# # 4. Starting experiment (publishing robot's goal and obstacles controllers)
...
do
  ...
  # 1. Simulation - amygdala
  open_ros_window "SIM_RUN_$i" "roslaunch mpc_planner test_architecture_dynamic.launch use_warm_start:=true test:='lr'"
  sleep 5
