...
BAG_NAME="MPC_dynamic"  
TOPICS="/odom /fearlevel /cmd_vel /gazebo/model_states /mpc/params /amygdala/lowroad/risks /amygdala/highroad/risks /odometry/filtered" 
DEST_FOLDER="/home/ros_ws/dual_pathway_model/bag_files/simulations/static_obstacles"
...
open_ros_window "SIMULATION" "roslaunch mpc_planner test_architecture_dynamic.launch"
sleep 5
...
# 3. VLM
# open_ros_window "VLM" "rosrun low_road VisualLanguageModel.py"
# sleep 2
